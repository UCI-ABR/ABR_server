...
**
** Created: Tue Nov 19 09:04:18 2013
...
static const char qt_meta_stringdata_Phone_item[] = {
    "Phone_item\0\0show_dialog()\0ima,size\0"
    "display_pix(QImage,int)\0"
};
...
int Phone_item::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: display_pix((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }
