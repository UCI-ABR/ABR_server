...
**
** Created: Fri Oct 26 15:42:31 2012
...
static const char qt_meta_stringdata_Camera_UDP_Object[] = {
    ...
    "frame_ready(QPixmap,int)\0read_image()\0"
    "close_socket()\0"
};
...
int Camera_UDP_Object::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: frame_ready((*reinterpret_cast< QPixmap(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
...
// SIGNAL 0
void Camera_UDP_Object::frame_ready(QPixmap _t1, int _t2)
{
